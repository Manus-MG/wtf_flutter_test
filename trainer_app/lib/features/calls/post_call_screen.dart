...
class PostCallScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final durationSec = cs.startedAt != null && cs.endedAt != null
        ? cs.endedAt!.difference(cs.startedAt!).inSeconds : 0;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (cs.sessionLogId != null)
                FilledButton.icon(
                  icon: const Icon(Icons.edit_note),
                  label: const Text('Add Session Notes'),
                  onPressed: () => context.go('/sessions/${cs.sessionLogId}/notes'),
                  style: FilledButton.styleFrom(minimumSize: const Size.fromHeight(52), backgroundColor: const Color(0xFFE50914)),
                ),
