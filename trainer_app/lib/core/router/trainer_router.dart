...
final trainerRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/chats/:chatId', builder: (_, s) => ChatPage(chatId: s.pathParameters['chatId']!)),
      ...
      GoRoute(path: '/sessions/:id/notes', builder: (_, s) => AddNotesPage(logId: s.pathParameters['id']!)),
