      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              FirebaseFirestore.instance.collection('dev_logs').get().then((snap) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('App: Guru App v0.0.1+1'),
...
class _LogTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = switch (entry.level) {
      DevLogLevel.info => Colors.blue,
      DevLogLevel.warn => const Color(0xFFF79009),
      DevLogLevel.error => const Color(0xFFD92D20),
    };
    ...
    return Card(
      ...
      child: InkWell(
        onLongPress: () {
          Clipboard.setData(ClipboardData(text: '${entry.tag} ${entry.message}'));
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: Text(entry.tag, style: TextStyle(fontSize: 11, color: color, fontWeight: FontWeight.bold)),
              ),
              const SizedBox(width: 8),
              Expanded(child: Text(entry.message, style: const TextStyle(fontSize: 12))),
              Text(
